					...
					<div className="relative z-20 flex w-full flex-col space-y-6 p-6">
						<div className="flex flex-col text-center">
							...
							<span
								...
								aria-disabled="false"
								aria-label="Volume"
								className="relative mb-2.5 mt-4 flex h-5 w-full touch-none items-center"
							>
								<span
									data-orientation="horizontal"
									className="relative h-1 w-full grow rounded-full bg-slate-5"
								>
									<span
										data-orientation="horizontal"
										className="absolute h-full rounded-full bg-gradient-to-r from-slate-12 to-slate-11"
										style={{ left: "0%", right: "79.0323%" }}
									></span>
								</span>
								<span
									style={{
								...
								>
									<span
										...
										data-orientation="horizontal"
										tabIndex={0}
										className="block h-5 w-5 cursor-grab rounded-full bg-black bg-gradient-to-r from-slate-12 to-slate-11 focus-visible:outline-none focus-visible:ring focus-visible:ring-slate-7 focus-visible:ring-opacity-75 active:cursor-grabbing dark:bg-white"
							...
							<span className="sans mb-4 text-center text-sm leading-[1.6] text-slate-12 font-normal">
								50,000 emails / mo
								<span className="mt-2 block text-slate-11">
